...
bench = fn n, repeats ->
  a =
    PolyHok.new_nx_from_function_arg(1, n * n, {:f, 32}, fn x ->
      (n * n - x) / 3000.0
    end)
  ...
  # warmup
  for _ <- 1..10 do
    _ = PGemv.gemm(gpu_a, gpu_b, n, n, n)
  end
  ...
  total_ms =
    System.convert_time_unit(stop - start, :native, :millisecond)
